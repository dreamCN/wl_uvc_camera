...
public class UVCCameraHelper {
    ...
    public void initUSBMonitor(Context context, CameraViewInterface cameraView, final OnMyDevConnectListener listener) {
    ...
    public void createUVCCamera() {
        ...
        mCameraHandler = UVCCameraHandler.createHandler(mContext, mCamView, 2,
